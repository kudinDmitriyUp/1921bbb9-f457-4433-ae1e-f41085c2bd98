...
export const metadata: Metadata = {
  title: "Idan Zeidman - Full-Stack Developer & Web Architect",
  description: "Portfolio of Idan Zeidman, full-stack developer specializing in modern web applications, scalable architecture, and innovative digital solutions.",
  keywords: "full-stack developer, web developer, React, Node.js, JavaScript, portfolio",
  metadataBase: new URL("https://example.com"),
  alternates: {
    canonical: "https://example.com"
  },
  openGraph: {
    title: "Idan Zeidman - Full-Stack Developer",
    description: "Discover my latest projects and technical expertise in modern web development",
    type: "website",
    siteName: "Idan Zeidman",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765890283253-m2x7dyyc.jpg",
        alt: "Idan Zeidman Portfolio"
      }
    ]
  },
  twitter: {
    ...
    title: "Idan Zeidman - Full-Stack Developer",
    description: "Explore my portfolio of innovative web applications and technical projects",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_339tT0ou1QLfW9e8sQWOCReXusx/uploaded-1765890283253-m2x7dyyc.jpg"]
  },
  robots: {
    index: true,
    follow: true
